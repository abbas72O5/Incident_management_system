...
<head>
    ...
    <title>Municipal Registration</title>
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&family=Playfair+Display:wght@700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        /* Same CSS as in traffic.php */
        :root {
            --primary: #6C63FF;
            --secondary: #4D44DB;
            --accent: #FF6584;
...
<body>
    <div class="form-container">
        <div class="form-header">
            <h2>Municipal Department Details</h2>
            <p>Complete your municipal registration</p>
        </div>
        ...
        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">
            ...
            <button type="submit" name="submit" class="btn-submit">
                <i class="fas fa-truck"></i> Submit Details
            </button>
        </form>
    </div>
</body>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $vehicle = $_POST['area'];
    $area =strtolower( $_POST['address']);
    $municipalID = $_POST['tid'];

    $sql = "INSERT INTO municipal (municipalID, area, officeAddress, authorityID)
            VALUES ('$municipalID', '$vehicle', '$area', '$authorityID')";

    if (mysqli_query($conn, $sql)) {
        echo "<div class='alert success'>✅ Municipal Registration Complete. Redirecting to Home...</div>";
        echo "<script>
            setTimeout(function() {
